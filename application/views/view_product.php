          ...
          <table id="example2" class="table table-bordered table-hover">
            <thead>
              <tr class = "text-center">
                ...
                <th class = "text-center">Offer Cart</th>
                <th class = "text-center">Offer Checkout</th>
              </tr>
            </thead>
            <tbody>
            <?php $sno = $page;
            foreach ($query as $row):
              ...
              <tr class="tbl_view text-center" >
                ...
                <td class = 'text-center' ><?php echo $row->offer_title_cart; ?></td>
                <td class = 'text-center' ><?php echo $row->offer_title_checkout; ?></td>
              </tr>
              <?php endforeach; ?>
            </tbody>
          </table>
